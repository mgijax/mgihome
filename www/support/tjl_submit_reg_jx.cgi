...
Remedy system. There are 2 versions of this script. This one is for
micetech and has the MGI headers and footers removed.
version 1.0 11/98      
...
def main():
		...
		if form.has_key('list:browser'):
                	browser = form['list:browser'].value
		else:
			browser = "Netscape"
		msg = \
                        '#' + NL \
