...
class myCGI (CGI.CGI):
	def main(self):
		...
		print '<H3>Thank you for registering!</H3>'
                print 'When downloading please note: '
                print '<p>' 
                print '<ul>'
                print '<li>If asked "What do you want to do with this file?," Choose '
                print '<b>Save it to disk. </b>'
                print '<li>When opening the GEN after downloading, choose <b>Enable Macros</b> to allow the GEN to operate optimally '
		print '</ul>'
                print '<p>' 
